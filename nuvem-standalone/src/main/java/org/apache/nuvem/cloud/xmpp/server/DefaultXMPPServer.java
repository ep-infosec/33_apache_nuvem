...
package org.apache.nuvem.cloud.xmpp.server;
...
public class DefaultXMPPServer implements XMPPServer {
	...
	public void start() {
		try {
			...
			accountManagement.addUser("nuvem@localhost", "password");
			accountManagement.addUser("reciever@localhost", "password");
